...
namespace Chambers.ViewModels
{
    public class FinishedStoryViewModel
    {
        ...
        {
            this.Story = "The four people come to in a strange set of chambers. " + party.LeftArbiterName + " and " + party.RightArbiterName + " find themselves in strange chambers separated by glass, the only notable features in each being two large buttons. Below them, " + party.LeftVictimName + " and " + party.RightVictimName + " slowly wake up in heavy restraints.<br/><br/>";
